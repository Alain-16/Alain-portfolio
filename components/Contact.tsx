    ...
    <section className="section contact" id="contact">
      <div className="wrap">
        <div className="section-head reveal">
          ...
          <p>
            Whether it&apos;s a role, a collaboration, or a project let&apos;s
            find time to talk.
          </p>
        </div>
        ...
        <div className="contact-grid">
          ...
          <div className="contact-info reveal" data-d="1">
            ...
            <div className="socials">
              <a
                href="www.linkedin.com/in/alainrw"
                aria-label="LinkedIn"
                title="LinkedIn"
              >
                <svg
              ...
              <a
                href="https://github.com/Alain-16"
                aria-label="GitHub"
                title="GitHub"
              >
                <svg
            ...
            <ul className="contact-assure">
              ...
              <li>
                Prefer email?{" "}
                <a href="mailto:mugishalain81@gmail.com">Reach me directly</a>
              </li>
            </ul>
          </div>
